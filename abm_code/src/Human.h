...
private:
    ...
    bool vaccinated;
    bool testedPreviousExposure;
    bool vaccineComplete;
    bool enrolledInTrial;    
    bool reportSymptoms;
    bool cohortCounted;
    bool popCounted;
    bool seroprevalenceCounted;
    bool enableTempImmunity;
...
public:
    ...
    void resetRecent();
    void setCohortCount(bool c_){cohortCounted = c_;}
    void setPopCount(bool c_){popCounted = c_;}
    void setSeroprevalenceCount(bool c_){seroprevalenceCounted = c_;}
    ...
    void setEnableTempImmunity(bool e){enableTempImmunity = e;}
    ...
    void updateVaccineEfficacy(unsigned int);
    ...
    bool isDeadFromInfection(){return willDieFromInfection;}
    ...
    bool isTestedPreviousExposure(){return testedPreviousExposure;}
    ...
    bool getCohortCount(){return cohortCounted;}
    bool getPopCount(){return popCounted;}
    bool getSeroprevalenceCount(){return seroprevalenceCounted;}
