...
void Simulation::readVaccineProfilesFile(){
	...
	for(int i = 0;i < numVaccines; i++){
		...
		if(line2 == "vaccine_protection_pos_" + s_id){
		    vaxTemp.setProtection(true,this->parseDouble(line3));
		}
		if(line2 == "vaccine_protection_neg_" + s_id){
		    vaxTemp.setProtection(false,this->parseDouble(line3));
		}
